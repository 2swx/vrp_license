...
MySQL.createCommand("vRP/licenses_check","SELECT * FROM vrp_users WHERE id=@id") -- bre faby license sys
...
-- bre faby license sys
function vRP.checkLicense(license)
  ...
  MySQL.query("vRP/licenses_check", {id = user_id}, function(rows,affected)
    ...
    if license == "lowweapons" then
      if lowweapons == "true" then
        return true
      end
    elseif license == "heavyweapons" then
      if heavyweapons == "true" then
        return true
      end
    elseif license == "cpp" then
      if cpp == "true" then
        return true
      end
    elseif license == "java" then
      if java == "true" then
        return true
      end
    elseif license == "law" then
      if law == "true" then
        return true
      end
    elseif license == "police" then
      if police == "true" then
        return true
      end
    elseif license == "medicine" then
      if medicine == "true" then
        return true
      end
    elseif license == "transport" then
      if transport == "true" then
        return true
      end
    elseif license == "chemistry" then
